namespace Repository.Constants.NotificationContents
{
    public static class NotificationText
    {
        // Vietnamese
        public const string OrderStatusTitle = "Cập nhật trạng thái đơn hàng";
        public const string OrderForStorePrefix = "Đơn hàng đặt từ";
        public const string OrderProcessed = "đã được xử lý";
